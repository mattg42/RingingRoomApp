...
extension View {
    func isLargeSize(_ isLargeSize: Bool) -> some View {
        environment(\.isLargeSize, isLargeSize)
    }
}
            ...
            ZStack {
                ...
                ZStack {
                    if isSplit {
                        ...
                        Color.primary
                            ...
                            .offset(x: viewModel.showingTowerControls ? 0 : -(geo.frame(in: .local).width), y: 0)
                ...
                GeometryReader { geo2 in
                    ...
                    .onAppear {
                        ...
                        isLargeSize = geo2.size.width > UIScreen.main.bounds.size.width
                    }
...
struct ChatNotificationButton:View {
    ...
    var body: some View {
        Button(action: {
            ...
            if !viewModel.showingTowerControls {
                viewModel.showingTowerControls = true
            }
        }) {
            ZStack {
