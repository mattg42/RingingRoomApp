...
struct PrivacyPolicyView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8.5) {
            Text("The Ringing Room app is independently operated by Matthew Goodship. This app doesn't collect any personal information. However, it does use the Ringing Room API to function. Therefore Ringing Room is able to see all the requests made and use that information, such as your email address, as they see fit. By using this app, you are subject to Ringing Room's Privacy Policy, which can be found at")
        ...
        .sheet(isPresented: $isShowingPrivacyPolicy, content: {
            NavigationView {
                webview
                    ...
                    .navigationBarItems(trailing: Button("Dismiss") {isShowingPrivacyPolicy = false})
            }                            .accentColor(.main)
